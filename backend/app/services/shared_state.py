        ...
        return [
            {
                ...
                "alert_worthiness_score": getattr(r, "alert_worthiness_score", None),
                "alert_trigger_type": getattr(r, "alert_trigger_type", None),
                "has_actionable_trigger": getattr(r, "has_actionable_trigger", False),
                "alert_state_key": getattr(r, "alert_state_key", None),
                "alert_block_reason": getattr(r, "alert_block_reason", None),
    ...
    *,
    ...
    async with async_session() as session:
        record = WorkspaceSignalProjectionRecord(
            ...
            alert_block_reason=alert_block_reason,
    ...
    async with async_session() as session:
        for proj in projections:
            record = WorkspaceSignalProjectionRecord(
                ...
                alert_worthiness_score=proj.get("alert_worthiness_score"),
                alert_trigger_type=proj.get("alert_trigger_type"),
                has_actionable_trigger=proj.get("has_actionable_trigger", False),
                alert_state_key=proj.get("alert_state_key"),
                alert_block_reason=proj.get("alert_block_reason"),
