...
def _make_opportunity() -> Opportunity:
    return Opportunity(
        ...
        has_actionable_trigger=True,
        alert_trigger_type="early_breakout",
        alert_worthiness_score=86.0,
        operational_buy_zone_low=123000,
        operational_buy_zone_high=124000,
        operational_sell_zone_low=128000,
        operational_sell_zone_high=130000,
        max_operable_order_notional_brl=1000,
